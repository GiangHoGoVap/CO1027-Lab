...
ChampionA::ChampionA(int _id, int _health, int _armor, int _magicResitance, int _physicalDamage, int _abilityPower)
	: Champion(_id, _health, _armor, _magicResitance, _physicalDamage, _abilityPower) {}
...
ChampionB::ChampionB(int _id, int _health, int _armor, int _magicResitance, int _physicalDamage, int _abilityPower)
	: Champion(_id, _health, _armor, _magicResitance, _physicalDamage, _abilityPower) {}
